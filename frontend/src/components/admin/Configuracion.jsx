            ...
            <div className="p-6 space-y-6 max-w-2xl">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      Redondeo de precios en POS
                    </label>
                    <select
                      value={config?.redondeo_precios || 0}
                      onChange={(e) => set('redondeo_precios', e.target.value)}
                      className="w-64 border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                    >
                      <option value="0">Sin redondeo</option>
                      <option value="1">Al $1 más cercano</option>
                      <option value="10">A los $10 más cercanos</option>
                      <option value="100">A los $100 más cercanos</option>
                    </select>
                    <p className="text-xs text-gray-400 mt-1">
                      Se aplica al calcular el total de la venta
                    </p>
                  </div>
                </div>
              </div>
